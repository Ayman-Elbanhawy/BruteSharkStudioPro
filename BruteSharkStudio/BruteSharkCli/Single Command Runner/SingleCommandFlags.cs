...
namespace BruteSharkCli
{
    public class SingleCommandFlags
    {
        ...
        [Option("hashcat-path", Required=false, Default=null, HelpText="Path to hashcat executable. If omitted, BruteShark Desktop Studio uses bundled Hashcat or 'hashcat' from PATH.")]
        public string HashcatPath { get; set; }

        [Option("hashcat-wordlist", Required=false, Default=null, HelpText="Run Hashcat against extracted hashes using this wordlist file. Requires -o/--output.")]
        public string HashcatWordlist { get; set; }

        [Option("hashcat-extra-args", Required=false, Default=null, HelpText="Additional arguments appended to the Hashcat cracking command.")]
        public string HashcatExtraArguments { get; set; }
    }
}
